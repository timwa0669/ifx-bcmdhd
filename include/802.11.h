...
/* Table 9-128 - Elements IDs(based on 802.11be_D4.1) */
#define EXT_MNG_EHT_OP_ID			106u	/* EHT Operation IE, 11be */
#define DOT11_MNG_EHT_OP_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_EHT_OP_ID)
#define EXT_MNG_MULTILINK_ID			107u	/* Multilink IE, 11be */
#define DOT11_MNG_MULTILINK_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_MULTILINK_ID)
#define EXT_MNG_EHT_CAP_ID			108u	/* EHT Capabilities, 11be */
#define DOT11_MNG_EHT_CAP_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_EHT_CAP_ID)
#define EXT_MNG_TID2LINK_ID			109u	/* TID-To-Link mapping IE, 11be */
#define DOT11_MNG_TID2LINK_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_TID2LINK_ID)
#define EXT_MNG_MLTRAFFIC_ID			110u	/* ML Traffic indication IE, 11be */
#define DOT11_MNG_MLTRAFFIC_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_MLTRAFFIC_ID)
#define EXT_MNG_QOS_CHAR_ID			113u	/* QoS Characteristics IE, 11be */
#define DOT11_MNG_QOS_CHAR_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_QOS_CHAR_ID)
#define EXT_MNG_MLO_LINKINFO_ID 		133u	/* MLO Link information IE, 11be */
#define DOT11_MNG_MLO_LINKINFO_ID		(DOT11_MNG_ID_EXT_ID + EXT_MNG_MLO_LINKINFO_ID)
#define EXT_MNG_AID_BMAP_ID			134u	/* AID bitmap IE, 11be */
#define DOT11_MNG_AID_BMAP_ID			(DOT11_MNG_ID_EXT_ID + EXT_MNG_AID_BMAP_ID)
#define EXT_MNG_BW_IND_ID			135u	/* Bandwidth indication IE, 11be */
