...
struct trxv5_header {
	...
	uint32 root_cert_start_offset;	/* Start Offset IDX for Root Certificate */
	uint32 content_cert_start_offset;	/* Start Offset IDX for Content Certificate */
	uint32 fw_entry;	/* Firmware Entry Point for CM mode */
	uint32 reserved;
};
